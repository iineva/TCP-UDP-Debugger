...
//    func ss_dictionaryFromObject() -> [String: Any] {
//        
//        
//        
//    }
    
    class func ss_dictionaryFromObject(obj: Any) -> [String: Any] {
...
//                let modelProperty = SSModelProperty()
//                modelProperty.key = element.label
//                modelProperty.value = element.value
//                items.append(modelProperty)
                
                if let key = element.label {
                    dic[key] = element.value
                }
            }
        }
...
//        
//        //get mirror
//        let obj:AnyObject = SSModel() //新建对象
